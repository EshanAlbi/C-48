...
function preload(){
  ...
  carAceelarationSound=loadSound("sounds/carVelocity.mp3");
  carCrashSound = loadSound("sounds/carCrash.mp3")
...
function pinkCyclists(){
  ...
  opponentPink=createSprite(600,Math.round(random(50,100),10,10));
...
function yellowCyclists(){
  ...
  opponentYellow=createSprite(600,Math.round(random(100,200),10,10));  opponentYellow.addAnimation("opponentYellow",opponentYellow1Image)
...
function redCyclists(){
  ...
  opponentRed=createSprite(600,Math.round(random(600,700),10,10));
...
function spawnObstcle1(){
  obstacle1=createSprite(600,Math.round(random(300,400),10,10))
...
function spawnObstcle2(){
  obstacle2=createSprite(600,Math.round(random(400,500),10,10))
...
function spawnObstcle3(){
  obstacle3=createSprite(600,Math.round(random(500,600),10,10))
...
function spawnEnemyCar1(){
  enemy1 =createSprite(600,Math.round(random(200,300),10,10))
...
function spawnEnemyCar2(){
  enemy2 =createSprite(600,Math.round(random(700,1000),10,10))
...
function spawnGold(){
  coin = createSprite(600,Math.round(random(0,1000),10,10))
